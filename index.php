...
<head>
    ...
    <title>Bangalore Car Rental</title>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: white">BANGALORE CAR RENTAL</h1>
                            <p class="intro-text">
        ...
        <div class="w3-row w3-padding-32 w3-section">
            ...
            <div class="w3-col m8 w3-panel">
                <div class="w3-large w3-margin-bottom">
                    ...
                    <i class="fa fa-envelope fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Email: bangalorecarrental@gmail.com<br>
                </div>
                <p>New to Bangalore ? Drop Your Details and Leave it on us We'll Revert</p>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© 2018 Bangalore Car Rental</h5>
                </div>
    ...
    <script>
        function myMap() {
            myCenter = new google.maps.LatLng(12.985409, 77.587670);
            var mapOptions = {
                center: myCenter,
                zoom: 12,
                scrollwheel: true,
